...
A four-part project building an Enterprise Data Architecture for an insurance company, from conceptual model through to a working application.
 
The business goal is to help the insurer anticipate chronic disease burden from social, economic and environmental factors, so that the resulting insight can inform product design, territory planning and the quote-to-policy workflow.
...
| 2 | `part2-logical-schema/part2_load_data.sql` | Reference data and staging |
| 3 | `part3-physical-ml/part3_physical_design.sql` | Indexes, partitions, materialized view |
...
| Source | Licence |
|--------|---------|
| [CDC/ATSDR Social Vulnerability Index](https://www.atsdr.cdc.gov/place-health/php/svi/index.html) | Public domain (US Government) |
| [CDC PLACES](https://www.cdc.gov/places/index.html) | Public domain (US Government) |
| [EPA Air Quality Data](https://www.epa.gov/outdoor-air-quality-data) | Public domain (US Government) |
